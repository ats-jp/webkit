...
<title>infinical demo (member schedule type)</title>
...
jQuery(document).ready(function() {
	jQuery.infinical.start(new Date(), {
		contextPath: "<%=request.getContextPath()%>" + "/infinicalmember",
...
<h2>infinical demo <font size="-1">(member schedule type)</font></h2>
